...
function Svg({ size = 18, children }: IconProps & { children: React.ReactNode }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">{children}</svg>;
}
...
export function IconGear(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      {/* Feather settings 齿轮路径(八齿 + 内圈 + 辐条),细线风格下仍清晰可辨 */}
...
/** 舞台入口:幕布(两根立柱 + 左右垂帘),与其余图标同细线语言。 */
export function IconStage(props: IconProps) {
  return <Svg {...props}><path d="M3 4v16"/><path d="M21 4v16"/><path d="M3 4c5 2.5 5 13.5 0 16"/><path d="M21 4c-5 2.5-5 13.5 0 16"/></Svg>;
}
/** 编辑入口:羽毛笔(编辑 agent 与文本编辑界面)。 */
export function IconEdit(props: IconProps) {
  return <Svg {...props}><path d="M17 3a2.83 2.83 0 0 1 4 4L7.5 20.5 2 22l1.5-5.5z"/></Svg>;
}
/** 关闭:X(弹窗右上角)。 */
...
export function IconTrash(props: IconProps) {
  return <Svg {...props}><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></Svg>;
}
