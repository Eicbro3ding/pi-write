 ...
 * thinking-level metadata from ../../pi-ai/src/index.ts to detect support for a concrete model.
 */
...
export interface AgentState {
	...
	temperature?: number;
	/** Nucleus sampling probability mass (0..1). Undefined = provider default. */
	topP?: number;
