...
import type {
	...
	ThinkingLevel,
	ToolExecutionMode,
} from "../../../../pi-agent-core/src/index.ts";
import type {
	Api,
...
export type WidgetPlacement = "aboveEditor" | "belowEditor" | "sidePanel";
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `../../../../pi-coding-agent/src/index.ts` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "../../../../pi-coding-agent/src/index.ts";
	 *
