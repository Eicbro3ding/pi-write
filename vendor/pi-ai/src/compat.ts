 ...
 *
 * Existing apps switch imports from "../../pi-ai/src/index.ts" to
 * "../../pi-ai/src/compat.ts" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "../../pi-ai/src/providers/all.ts" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "../../pi-ai/src/providers/all.ts" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "../../pi-ai/src/providers/all.ts" or `Models.getProviders()`. */
